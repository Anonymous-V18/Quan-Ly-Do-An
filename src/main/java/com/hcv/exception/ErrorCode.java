...
public enum ErrorCode {
    ...
    SUBJECT_ID_INVALID(1076, "Subject id is invalid !", HttpStatus.BAD_REQUEST),
    TEACHER_EXISTED_OTHER_COUNCIL(1077, "Teacher existed in other council !", HttpStatus.CONFLICT),
    INVALID_PARAM(1078, "Parameter is invalid !", HttpStatus.BAD_REQUEST),
