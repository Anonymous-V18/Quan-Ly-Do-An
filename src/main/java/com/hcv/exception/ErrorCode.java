...
public enum ErrorCode {
    ...
    DEPARTMENT_NOT_EXISTED(1005, "Department didn't exist !"),
    ...
    INVALID_LIST_STUDENT(1006, "List of students is null or invalid !"),
    SUBJECT_EXISTED(1007, "Subject existed !"),
    SUBJECT_NOT_EXISTED(1007, "Subject isn't exist !"),
    ...
    INVALID_LIST_TEACHER(1006, "List of teachers is null or invalid !"),
    TEACHER_NOT_EXISTED(1008, "Teacher isn't exist !"),
